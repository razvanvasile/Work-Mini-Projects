...
''' Short script to find all classes inside the APHLA library
  - print all classes inside the aphla directory
...
def parse_data(raw_data):
    ...
    # TODO: parse data for when the search object is def
